...
def video_start(self):
    if self.session_info['ephys_rig']:
        ...
        try:
            ...
            print(Fore.CYAN + "\nStart Previewing ..." + Style.RESET_ALL)
            print(Fore.RED + "\n CRTL + C to quit previewing and start recording" + Style.RESET_ALL)
            os.system("ssh pi@" + self.IP_address_video + " '/home/pi/RPi4_behavior_boxes/video_acquisition/old/start_preview.py'")
            ...
            tempstr = (
                    "ssh pi@" + self.IP_address_video + " 'nohup /home/pi/RPi4_behavior_boxes/video_acquisition/old/start_acquisition.py "
                    + self.session_info['file_basename']
...
def video_stop(self):
    if self.session_info['ephys_rig']:
        try:
            os.system("sh ./video_acquisition/old/stop_acquisition.sh")
        except Exception as error_message:
        ...
        try:
            os.system(
                "ssh pi@" + self.IP_address_video + " /home/pi/RPi4_behavior_boxes/video_acquisition/old/stop_acquisition.sh")
