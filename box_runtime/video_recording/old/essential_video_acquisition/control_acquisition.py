...
os.system("python3 /home/pi/RPi4_behavior_boxes/box_runtime/video_recording/old/start_acquisition.py /home/pi/video/test &")
sleep(duration + 4)
os.system("/home/pi/RPi4_behavior_boxes/box_runtime/video_recording/old/stop_acquisition.sh")
